...
## Corpus Check
- Large corpus: 1536 files · ~281,985 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1207 nodes · 3050 edges · 63 communities detected
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output
- Edge kinds: imports: 919 · contains: 751 · imports_from: 572 · MODIFIES: 373 · conceptually_related_to: 187 · references: 108 · calls: 46 · shares_data_with: 36 · ON_BRANCH: 18 · PARENT_OF: 17 · cites: 7 · rationale_for: 5 · semantically_similar_to: 5 · implements: 4 · inherits: 2
...
- Excluded: 2 untracked · 58746 ignored · 6 sensitive · 57 missing committed
...
Cohesion: 0.05
Nodes (42): AVATAR_DIR, main, 2ee7082 version 3, 2f6d845 revision 1, 3b141c8 16/07/2026, 41cf842 documentacion, 583a96a 15/07/2026, 6688ce2 version 10 (+34 more)

### Community 2 - "UI Utilities & Marquee"
Cohesion: 0.06
Nodes (35): AcquisitionForm(), num(), CAMPAIGN_TYPE_OPTIONS, CampaignData, CampaignForm(), CampaignFormProps, CampaignType, numStr() (+27 more)
...
Cohesion: 0.04
Nodes (4): 2982ca1 iniciar proyecto, eslintConfig, config, registerSchema

### Community 5 - "Auth Layout & Test Config"
Cohesion: 0.07
Nodes (28): RANGES, statusLabels, CashFlowChart(), TooltipPayload, DonutTooltipPayload, LogisticsDonut(), SLICE_STYLE, DeptFeatureProps (+20 more)

### Community 6 - "Acquisitions & Shalom API Routes"
Cohesion: 0.09
Nodes (21): CampaignItem, STATUS_LABELS, TYPE_LABELS, WhatsappIcon(), SortSelect(), SortSelectProps, PasswordFormData, passwordSchema (+13 more)
...
Cohesion: 0.08
Nodes (26): AnnouncementBar(), Footer(), Header(), benefits, TopBar(), FilterOption, FilterSection(), FilterSectionProps (+18 more)

### Community 9 - "Admin CRM Input Forms"
Cohesion: 0.17
Nodes (17): CrmPanelProps, TIER_LABELS, StatsCardProps, ResetFormData, resetSchema, ManualPaymentSection(), ManualPaymentSectionProps, ImageLightbox() (+9 more)
...
Cohesion: 0.11
Nodes (10): AnimatedThemeToggle(), navLinks, MobileNav(), ThemeToggle(), DropdownMenu(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel() (+2 more)
...
Cohesion: 0.16
Nodes (11): AdminSidebar(), navigation, CartItem(), CartItemProps, CartSummary(), CartSummaryProps, links, navigation (+3 more)

### Community 19 - "Home Marquee Components"
Cohesion: 0.16
Nodes (15): OrderSummary(), OrderSummaryProps, 3db2e43 version 2, BundleDiscount, calculateBundleDiscount(), effectivePrice(), PricingItem, ProductBundle() (+7 more)
...
Cohesion: 0.16
Nodes (11): AdminMobileNav(), navigation, FilterMobile(), FilterMobileProps, FilterSidebar(), FilterState, Sheet(), SheetContent() (+3 more)
...
Cohesion: 0.20
Nodes (10): GoogleButton(), LoginFormData, loginSchema, RegisterFormData, registerSchema, Field, FieldDescription, FieldError (+2 more)
...
Cohesion: 0.19
Nodes (11): adapter, ANIMES_DIR, generatedPasswords, LINEAS_DIR, main(), pool, prisma, PUBLIC_DIR (+3 more)
...
## Knowledge Gaps
- **324 isolated node(s):** `eslintConfig`, `csp`, `securityHeaders`, `nextConfig`, `config` (+319 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Stats Counter Animation`** (2 nodes): `shippingIcons`, `shippingLabels`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Brand/Line Migration`** (2 nodes): `Avatar()`, `AvatarFallback()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Separation Payments Migration`** (2 nodes): `brands`, `lines`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (2 nodes): `preorder_reservations`, `separation_payments`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
