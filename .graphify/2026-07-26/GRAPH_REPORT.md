...
## Corpus Check
- Large corpus: 1561 files · ~296,983 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1278 nodes · 3267 edges · 73 communities detected
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output
- Edge kinds: imports: 986 · contains: 799 · imports_from: 614 · MODIFIES: 411 · conceptually_related_to: 187 · references: 110 · calls: 52 · shares_data_with: 36 · ON_BRANCH: 25 · PARENT_OF: 24 · cites: 7 · rationale_for: 5 · semantically_similar_to: 5 · implements: 4 · inherits: 2


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1561 · Candidates: 1743
- Excluded: 0 untracked · 60127 ignored · 6 sensitive · 57 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `c4e3f45`
...
Cohesion: 0.07
Nodes (28): AdminMobileNav(), navigation, DOT, NotificationBell(), NotifItem, AnimatedThemeToggle(), navLinks, links (+20 more)

### Community 1 - "Campaign & Catalog Forms"
Cohesion: 0.11
Nodes (28): Acquisition, AcquisitionsTab(), MonthSummary, Summary, Contact, ShalomDirectoryTab(), StockProduct, ENDPOINT (+20 more)

### Community 2 - "UI Utilities & Marquee"
Cohesion: 0.06
Nodes (43): AVATAR_DIR, main, 2ee7082 version 3, 2f6d845 revision 1, 3b141c8 16/07/2026, 41cf842 documentacion, 583a96a 15/07/2026, 6688ce2 version 10 (+35 more)
...
Cohesion: 0.07
Nodes (13): createSchema, itemSchema, f8a3c09 version 11, requireAdmin(), globalForPrisma, schema, Params, schema (+5 more)
...
Cohesion: 0.07
Nodes (25): HoldToConfirm(), ProgressBar(), SEMAPHORE_STYLES, SemaphoreBadge(), SemaphoreLevel, ShalomContactData, ShalomContactForm(), Batch (+17 more)

### Community 7 - "Auth Forms & Register Flow"
Cohesion: 0.08
Nodes (28): AnnouncementBar(), Footer(), Header(), benefits, TopBar(), FilterOption, FilterSection(), FilterSectionProps (+20 more)

### Community 8 - "Campaign List Page"
Cohesion: 0.10
Nodes (21): applyDiscountRules(), CouponValidation, getActiveAnnouncement(), getActiveBanners(), getActiveDiscountRules(), isCampaignLive(), liveCampaignWhere(), PriceableProduct (+13 more)

### Community 9 - "Admin CRM Input Forms"
Cohesion: 0.08
Nodes (13): AuthShell(), FEATURES, ForcedResetForm(), LoginForm(), RegisterForm(), schema, { handlers, signIn, signOut, auth }, isGoogleEnabled() (+5 more)
...
Cohesion: 0.08
Nodes (13): MessageComposer(), StickerItem, StickerPicker(), BatchOpt, FormValues, LineItem, ProductOpt, schema (+5 more)

### Community 14 - "TestSprite Findings Report"
Cohesion: 0.17
Nodes (14): b975a3a version 6, GradientText(), BuyMeACoffee(), CategoryTrends(), FeaturedProducts(), LinesSection(), QuickAccessPanel(), quickLinks (+6 more)

### Community 15 - "Brand/Category API & Transformers"
Cohesion: 0.18
Nodes (12): StatsCardProps, ResetFormData, resetSchema, ManualPaymentSection(), ManualPaymentSectionProps, ImageLightbox(), Card(), CardContent() (+4 more)
...
Cohesion: 0.13
Nodes (12): WhatsappIcon(), SortSelect(), SortSelectProps, PasswordFormData, passwordSchema, ProfileSettingsForm(), ProfileSettingsFormProps, SettingsFormData (+4 more)
...
Cohesion: 0.19
Nodes (12): 3db2e43 version 2, BundleDiscount, calculateBundleDiscount(), effectivePrice(), PricingItem, ProductBundle(), ProductBundleProps, ProductDetail() (+4 more)

### Community 20 - "Campaigns & Coupon Validation"
Cohesion: 0.12
Nodes (9): brands, lines, preorder_reservations, separation_payments, acquisitions, shalom_contacts, categorySchema, 487cc56 version 4 (+1 more)
...
Cohesion: 0.16
Nodes (9): Category, statusBadge, Breadcrumb(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList(), BreadcrumbPage(), BreadcrumbSeparator() (+1 more)
...
Cohesion: 0.16
Nodes (11): CAMPAIGN_TYPE_OPTIONS, CampaignData, CampaignForm(), CampaignFormProps, CampaignType, numStr(), Option, toLocalInput() (+3 more)
...
Cohesion: 0.18
Nodes (8): CampaignItem, STATUS_LABELS, TYPE_LABELS, Switch(), Tabs(), TabsContent(), TabsList(), TabsTrigger()
...
Cohesion: 0.18
Nodes (9): CartItem(), CartItemProps, CartSummary(), CartSummaryProps, OrderSummary(), OrderSummaryProps, navigation, CartItem (+1 more)
...
Cohesion: 0.22
Nodes (11): AcquisitionData, AcquisitionForm(), num(), CrmPanel(), CrmPanelProps, TIER_LABELS, CardDescription(), Label() (+3 more)

### Community 35 - "Preventas y Separaciones"
Cohesion: 0.21
Nodes (7): AdminSidebar(), navigation, GoogleButton(), LoginFormData, loginSchema, Button(), buttonVariants

### Community 36 - "Legal Pages (Terms/Privacy)"
Cohesion: 0.25
Nodes (9): SOCIAL_BG, SocialIcon(), TiktokIcon(), FollowUs(), SOCIAL_LINKS, SocialLink, SocialPlatform, ManchasStoreBanner() (+1 more)

### Community 37 - "PRD Resumen de Requisitos"
Cohesion: 0.15
Nodes (7): slugify(), lineSchema, PriceFilter(), PriceFilterProps, ProductGallery(), ProductGalleryProps, Slider()

### Community 38 - "Checkout Coupon & Shipping"
Cohesion: 0.16
Nodes (9): ContactBadges(), tiktokProfileUrl(), whatsappChatUrl(), ManualPaymentsPage(), money(), PosCustomer, PosOrder, PosSeparationPayment (+1 more)

### Community 39 - "Transactional Email Sending"
Cohesion: 0.32
Nodes (12): ADMIN_ALERT_LABELS, client(), layout(), OrderEmailData, orderRow(), send(), sendAdminPaymentAlertEmail(), sendOrderDeliveredEmail() (+4 more)

### Community 40 - "Core DB Migration Schema"
Cohesion: 0.19
Nodes (4): ImageLightboxProps, Dialog(), DialogContent(), DialogTitle()
...
Cohesion: 0.21
Nodes (7): cn(), navigation, ProfileMobileNav(), ProfileSidebar(), TiltCardProps, ScrollArea(), ScrollBar()
...
Cohesion: 0.20
Nodes (7): requireUser(), transformReview(), hasVerifiedPurchase(), POST(), reviewSchema, VERIFIED_STATUSES, schema
...
Cohesion: 0.22
Nodes (8): BrandOption, CatalogEntryForm(), CatalogEntryFormProps, CatalogEntryType, ENDPOINT, TYPE_OPTIONS, UPLOAD_FOLDER, Checkbox()

### Community 53 - "Git Commit History"
Cohesion: 0.22
Nodes (8): ImageUpload(), ImageUploadProps, UploadedImage, Option, ProductFormData, ProductFormProps, productSchema, UploadedImage
...
Cohesion: 0.29
Nodes (3): useCoarsePointer(), MagneticButton(), MagneticButtonProps
...
Cohesion: 0.40
Nodes (2): brandSchema, transformBrand()
...
Cohesion: 0.67
Nodes (3): buildPageList(), Pagination(), PaginationProps
...
## Knowledge Gaps
- **342 isolated node(s):** `eslintConfig`, `csp`, `securityHeaders`, `nextConfig`, `config` (+337 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 64`** (2 nodes): `shippingIcons`, `shippingLabels`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (2 nodes): `brandSchema`, `transformBrand()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (1 nodes): `registerSchema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (2 nodes): `Badge()`, `badgeVariants`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
