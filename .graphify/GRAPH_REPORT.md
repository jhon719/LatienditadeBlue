...
## Corpus Check
- Large corpus: 1536 files · ~282,970 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.
...
- Excluded: 33 untracked · 59755 ignored · 6 sensitive · 57 missing committed
