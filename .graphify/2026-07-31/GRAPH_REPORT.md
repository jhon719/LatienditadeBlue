...
## Corpus Check
- Large corpus: 1599 files · ~326,332 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1427 nodes · 3684 edges · 76 communities detected
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output
- Edge kinds: imports: 1061 · contains: 895 · imports_from: 682 · MODIFIES: 534 · conceptually_related_to: 187 · references: 110 · calls: 71 · ON_BRANCH: 43 · PARENT_OF: 42 · shares_data_with: 36 · cites: 7 · rationale_for: 5 · semantically_similar_to: 5 · implements: 4 · inherits: 2
...
- Excluded: 5 untracked · 66195 ignored · 6 sensitive · 57 missing committed
...
Cohesion: 0.06
Nodes (32): ContactBadges(), SOCIAL_BG, SocialIcon(), TiktokIcon(), WhatsappIcon(), FollowUs(), QuickAccessPanel(), quickLinks (+24 more)

### Community 2 - "UI Utilities & Marquee"
Cohesion: 0.07
Nodes (14): createSchema, itemSchema, 8cfce9e feat: mejorar formulario de lotes de importacion y agregar reportes de logistica, requireAdmin(), requireUser(), globalForPrisma, schema, Severity (+6 more)
...
Cohesion: 0.13
Nodes (17): CartItem(), CartItemProps, CartSummary(), CartSummaryProps, OrderSummary(), OrderSummaryProps, 2ee7082 version 3, 3db2e43 version 2 (+9 more)
...
Cohesion: 0.11
Nodes (20): OrderWithItems, parseProductSpecs(), ProductWithRelations, ReviewWithUser, transformOrder(), transformProduct(), WithCount, defaultFilters (+12 more)

### Community 20 - "Campaigns & Coupon Validation"
Cohesion: 0.12
Nodes (17): ImageUpload(), ImageUploadProps, UploadedImage, LinkedBatch, Option, ProductFormData, ProductFormProps, productSchema (+9 more)
...
Cohesion: 0.13
Nodes (8): brands, lines, preorder_reservations, separation_payments, acquisitions, shalom_contacts, 487cc56 version 4, schema
...
Cohesion: 0.13
Nodes (7): brandSchema, categorySchema, transformBrand(), transformCategory(), transformLine(), slugify(), lineSchema
...
Cohesion: 0.24
Nodes (8): 0a444d0 18/97/2026, UserAvatar(), UserAvatarProps, ReviewsSection(), ProductReviews(), ReviewFormData, reviewSchema, ReviewItem
...
Cohesion: 0.40
Nodes (2): getActiveDiscountRules(), createProductSchema
...
- **Thin community `Community 70`** (2 nodes): `shippingIcons`, `shippingLabels`
...
- **Thin community `Community 71`** (1 nodes): `7f3209a feat: add sitemap.xml, robots.txt and Google OAuth data disclosure`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (2 nodes): `getActiveDiscountRules()`, `createProductSchema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
