...
Cohesion: 0.06
Nodes (27): ContactBadges(), SOCIAL_BG, SocialIcon(), TiktokIcon(), WhatsappIcon(), FollowUs(), LegalBlock, LegalPage() (+19 more)

### Community 3 - "Admin Header & Theme Toggle"
Cohesion: 0.06
Nodes (25): CAMPAIGN_TYPE_OPTIONS, CampaignData, CampaignForm(), CampaignFormProps, CampaignType, numStr(), Option, toLocalInput() (+17 more)

### Community 4 - "Admin Order & Batch Tracking"
Cohesion: 0.08
Nodes (13): HoldToConfirm(), f8a3c09 version 11, requireAdmin(), requireUser(), globalForPrisma, schema, Params, schema (+5 more)
...
Cohesion: 0.09
Nodes (16): brandSchema, categorySchema, getActiveDiscountRules(), OrderWithItems, ProductWithRelations, ReviewWithUser, transformBrand(), transformCategory() (+8 more)
...
Cohesion: 0.11
Nodes (12): AnimatedThemeToggle(), Header(), navLinks, DOT, NotifItem, UserNotificationBell(), DropdownMenu(), DropdownMenuContent() (+4 more)
...
Cohesion: 0.18
Nodes (11): defaultFilters, ProductsState, Brand, CategoryRef, Line, OrderStatusType, OrderSummaryItem, PaymentMethodType (+3 more)
...
Cohesion: 0.23
Nodes (9): QuickAccessPanel(), quickLinks, StoreLocations(), mapEmbedUrl(), PICKUP_POINTS, PickupPoint, storeWhatsappUrl(), whatsappChatUrl() (+1 more)

### Community 48 - "Mercado Pago Client Setup"
Cohesion: 0.18
Nodes (10): FilterOption, FilterSection(), FilterSectionProps, FilterSidebarProps, STATUS_OPTIONS, TYPE_OPTIONS, useProductsStore, PRODUCT_TYPE_LABELS (+2 more)
