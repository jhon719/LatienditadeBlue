...
10. **Liberación de stock (06.01)** — órdenes de pasarela colgadas en PENDING_PAYMENT se cancelan y liberan stock (60 min por defecto, `STOCK_RELEASE_MINUTES`); endpoint `/api/cron/release-stock` (cron externo con `CRON_SECRET`) + disparo oportunista al abrir el dashboard admin
